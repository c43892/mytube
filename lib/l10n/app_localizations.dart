...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Failed to load home videos: {error}'**
  ...
  /// No description provided for @downloadInitFailed.
  ///
  /// In en, this message translates to:
  /// **'Download init failed: {error}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Download failed/cancelled, please retry'**
